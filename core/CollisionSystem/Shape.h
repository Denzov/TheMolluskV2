...
namespace Shape {
    ...
    struct BoundsGetter{
        Shape::AABB operator()(const Shape::Circle form) const;
        Shape::AABB operator()(const Shape::AABB form) const;
    };

    inline Shape::AABB getShapeBounds(const Shape::Variant form){
        return std::visit(BoundsGetter{}, form);
    }
}
