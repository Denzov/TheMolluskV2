#ifndef _SECOND_ORDER_MOVING_MODEL_H_
#define _SECOND_ORDER_MOVING_MODEL_H_
...
class SecondOrderMovingModel :
    public IMovingModel
{
public:
    SecondOrderMovingModel(
        SecondOrderMovingProperty property) :
        _property(property){}

    Vector2 process(MovingCue intent,
...
#endif // !_SECOND_ORDER_MOVING_MODEL_H_